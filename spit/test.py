...
#images_val, cls_val, labels_val, filenames_val = preprocess.load_linear_pngs(data_type="validation_data")
#images_test, cls_test, labels_test, filenames_test = preprocess.load_linear_pngs(data_type="test_data")
images_test, cls_test, labels_test, filenames_test = preprocess.load_linear_pngs(data_type="train_data")

#images_train, cls_train, labels_train, filenames_train = preprocess.load_images()
#images_val, cls_val, labels_val, filenames_val = preprocess.load_images()
#images_test, cls_test, labels_test, filenames_test = preprocess.load_images()
...
save_dir = 'checkpoints_final_97/'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
save_path = os.path.join(save_dir, 'best_validation')
#done_path = os.path.join(save_dir, 'done_testing')
...
print("Print Best case accuracies!")
print_test_accuracy()

#images_test, cls_test, labels_test, filenames_test = preprocess.load_all_data()
